...
import 'package:favorit_list/utils/app_routes.dart';

class ClothesItens extends StatelessWidget {
  final Clothes clothes;
  // ignore: use_key_in_widget_constructors
  const ClothesItens(this.meal);

  //Função
  void _selectClothes(BuildContext context) {
    Navigator.of(context).pushNamed(
      AppRoutes.clothes_details,
      arguments: clothes,
    );
  }
